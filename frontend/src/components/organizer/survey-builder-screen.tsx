        ...
        <div className="space-y-5">
          <Card className="p-5 sm:p-7">
            <div className="space-y-3 text-sm leading-6 text-[var(--muted)]">
              <p>Say your survey name and what participants should know, such as its purpose and how their responses will be used. AI can polish the wording if you like.</p>
