...
export function ReviewScreen({ publicToken }: { publicToken: string }) {
  ...
  return (
    <ParticipantShell>
      ...
      <div className="mt-3"><p className="text-xs font-bold uppercase tracking-[0.16em] text-[var(--coral-dark)]">Final check</p><h1 className="font-display mt-3 text-3xl font-bold tracking-[-0.025em] sm:text-4xl">Review your words</h1></div>
